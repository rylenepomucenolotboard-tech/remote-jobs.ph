                ...
                <section className="py-32 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-20">
                            <span className="inline-block px-4 py-2 bg-accent-cyber/10 text-accent-cyber border border-accent-cyber/20 rounded-full text-[10px] font-black uppercase t
mkdir -p ~/Documents/Antigravity/app/find-jobs && cat > ~/Documents/Antigravity/app/find-jobs/page.tsx << 'EOF'
'use client';
